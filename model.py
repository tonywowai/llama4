...
class MyModel(AIxBlockMLBase):
    ...
    def action(self,  command,**kwargs):
        ...
        if command.lower() == "train":
                ...
                model_id = kwargs.get("model_id", "meta-llama/Llama-3.2-3B")  #"tiiuae/falcon-7b" "bigscience/bloomz-1b7" `zanchat/falcon-1b` `appvoid/llama-3-1b` meta-llama/Llama-3.2-3B` `mistralai/Mistral-7B-v0.1` `bigscience/bloomz-1b7` `Qwen/Qwen2-1.5B`
            ...
            try:
                ...
                model_id = kwargs.get("model_id", "meta-llama/Llama-3.2-3B")
    ...
    #     llama_models = {
    #         "DeepSeek-R1-Distill-Qwen-1.5B": "meta-llama/Llama-3.2-3B",
    ...
    def model(self, **kwargs):
        ...
        task = kwargs.get("task", "text-generation")
        model_id = kwargs.get("model_id", "meta-llama/Llama-3.2-3B")
        if "deepseek" not in "meta-llama/Llama-3.2-3B":
